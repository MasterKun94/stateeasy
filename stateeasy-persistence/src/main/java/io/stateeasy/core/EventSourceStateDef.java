...
public interface EventSourceStateDef<STATE, EVENT> extends StateDef<STATE, EVENT> {
    /**
     * Provides an {@link EventStore} for managing events. The event store is responsible for
     * storing, appending, expiring, and recovering events, as well as flushing the store to ensure
