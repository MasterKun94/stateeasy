...
public class DefaultEventFutureTest {
    ...
    @Test
    public void testFlatmapSuccess() throws InterruptedException {
        DefaultEventFuture<String> future = new DefaultEventFuture<>(executor);
        future.success("success");
        EventFuture<Integer> flatMappedFuture = future.flatmap(value -> EventFuture.supplyAsync(value::length, executor));
