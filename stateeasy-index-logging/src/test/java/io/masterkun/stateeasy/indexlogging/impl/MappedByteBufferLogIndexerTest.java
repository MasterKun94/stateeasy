...
public class MappedByteBufferLogIndexerTest {
    ...
    public void test() throws IOException {
        MappedByteBufferLogIndexer indexer = MappedByteBufferLogIndexer.create(testFile,
                1024 * 1024);
        ...
        indexer.append(9, 800);
        indexer.append(10, 811);
        indexer.append(11, 822);
        indexer.append(12, 833);
        indexer.append(13, 854);
        indexer.append(100, 900);
        indexer.append(101, 911);
        indexer.append(102, 922);
        Assert.assertEquals(0, indexer.offsetBefore(0));
        Assert.assertEquals(0, indexer.offsetBefore(1));
        Assert.assertEquals(123, indexer.offsetBefore(2));
        Assert.assertEquals(123, indexer.offsetBefore(3));
        ...
        MappedByteBufferLogIndexer recover = MappedByteBufferLogIndexer.recover(testFile,
                1024 * 1024, false);
