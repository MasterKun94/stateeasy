...
public class MappedByteBufferLogIndexerTest {
    ...
    public void test() throws IOException {
        io.masterkun.stateeasy.indexlogging.impl.MappedByteBufferLogIndexer indexer = io.masterkun.stateeasy.indexlogging.impl.MappedByteBufferLogIndexer.create(testFile, 1024 * 1024);
        ...
        io.masterkun.stateeasy.indexlogging.impl.MappedByteBufferLogIndexer recover = io.masterkun.stateeasy.indexlogging.impl.MappedByteBufferLogIndexer.recover(testFile, 1024 * 1024, false);
