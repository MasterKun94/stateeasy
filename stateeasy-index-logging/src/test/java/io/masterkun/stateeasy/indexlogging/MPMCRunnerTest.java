...
public class MPMCRunnerTest {
    ...
    public void test() throws Exception {
        ...
        io.masterkun.stateeasy.indexlogging.LogConfig config = LogConfig.builder("test", testDir)
                ...
                .build();
        io.masterkun.stateeasy.indexlogging.Serializer<String> serializer = new Serializer<>() {
            @Override
        ...
        io.masterkun.stateeasy.indexlogging.EventLogger<String> logger = system.get(config, serializer);
