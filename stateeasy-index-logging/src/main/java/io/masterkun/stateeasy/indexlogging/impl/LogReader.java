 ...
 * {@link MappedByteBufferLogReader} and provides methods for setting the readable offset, getting offsets,
 * and iterating over log segments.
 *
 * <p>This interface includes static factory methods for creating or recovering a log reader instance.
 *
...
sealed interface LogReader permits MappedByteBufferLogReader {
    ...
    /**
     * Recovers a log reader from the given file, using the provided indexer to help in the recovery process.
     *
     ...
     * @param id          the ID of the log segment
     * @return the next offset after the specified offset for the given log segment ID, or -1 if no such offset exists
     */
