...
/**
 * A specialized input stream that reads data from a {@link ByteBuffer} and implements the {@link Serializer.DataIn} interface.
 * This class provides methods to read various types of data (such as bytes, shorts, ints, longs, floats, doubles,
 * booleans, and strings) from the underlying byte buffer. It also supports reading into other buffers and skipping
 * bytes.
 */
