 ...
 * whether the buffer is direct or non-direct. This class extends {@link OutputStream} and implements
 * the {@link Serializer.DataOut} interface, providing methods for writing various types of data.
 *
 * <p>The buffer's capacity can be dynamically increased as needed, up to a specified maximum capacity.
 * If the maximum capacity is exceeded, a {@link java.nio.BufferOverflowException} is thrown.
 *
...
public class ByteBufferDataOutputStream extends OutputStream implements Serializer.DataOut {
    ...
    /**
     * @param direct          if true, the underlying buffer will be a direct byte buffer; otherwise, it will be a non-direct buffer
     * @param initialCapacity the initial capacity of the buffer
     * @param maxCapacity     the maximum capacity of the buffer. If 0 or negative, the maximum capacity is set to Integer.MAX_VALUE
     */
    ...
    /**
     * Constructs a new {@code ByteBufferDataOutputStream} that writes data to the specified byte buffer.
     *
