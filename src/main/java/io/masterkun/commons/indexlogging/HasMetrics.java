...
/**
 * Interface for components that can register metrics with a {@link MeterRegistry}.
 * Implementing this interface allows the component to expose its metrics, such as counters, gauges, and timers,
...
public interface HasMetrics {
     ...
     *
     * @param metricPrefix the prefix to be used for all metrics registered by this component, may be null
