...
import io.masterkun.commons.indexlogging.impl.LogSegmentRecord;

import java.util.Objects;

/**
 * Represents a log record that encapsulates an ID, offset, and a value. This class is used to manage log entries
 * in a logging system, providing methods to compute the final ID and offset of the log entry.
 *
 * <p>The {@code LogRecord} class is designed to be immutable, with the ID and offset being computed based on
 * initial values and the values from the encapsulated {@link LogSegmentRecord}.
 *
