 ...
 * <p>
 * Implementations of this interface provide the necessary logic to convert objects of a specific type into a byte
 * stream (serialization) and to reconstruct objects from a byte stream (deserialization).
 *
...
public interface Serializer<T> {
    ...
    interface DataIn extends DataInput {
        ...
        /**
         * Reads data from the input source and fills the specified {@link ByteBuffer} until it is full.
         *
         * @param buf the buffer to read data into
         * @throws IOException if an I/O error occurs during the read operation
         */
        ...
        /**
         * Reads data from the input source and fills the specified portion of the {@link ByteBuffer} until the given length is reached.
         *
         * @param buf the buffer to read data into
    ...
    interface DataOut extends DataOutput, Closeable {
        ...
        /**
         * Writes a portion of the specified {@link ByteBuffer} to the output source, starting from the given offset and
         * writing up to the specified length.
         *
         * @param buf the {@link ByteBuffer} containing the data to be written
